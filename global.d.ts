...
declare module "cloudinary" {
  ...
  export namespace v2 {
    ...
    namespace utils {
      ...
      function download_backedup_asset(
        asset_id?: string,
        version_id?: string,
        options?: ArchiveApiOptions | ConfigAndUrlOptions
      ): string;
    ...
    namespace api {
      ...
      function resources_by_asset_ids(
      ...
      function resources_by_asset_folder(
        asset_folder: string,
        options?: AdminAndResourceOptions,
        callback?: ResponseCallback
      ): Promise<ResourceApiResponse>;
      ...
      function tags(
        options?:
          | AdminApiOptions
          | { max_results?: number; next_cursor?: string; prefix?: string },
        callback?: ResponseCallback
      ): Promise<any>;
      ...
      function transformation(
        ...
        options?:
          | AdminApiOptions
          | { max_results?: number; next_cursor?: string; named?: boolean },
        callback?: ResponseCallback
      ): Promise<any>;
    ...
    namespace uploader {
      ...
      function destroy(
        public_id: string,
        options?: { resource_type?: ResourceType; type?: DeliveryType; invalidate?: boolean },
        callback?: ResponseCallback
      ): Promise<any>;
      ...
      function remove_all_context(
        public_ids: string[],
        options?: { context?: string; resource_type?: ResourceType; type?: DeliveryType },
        callback?: ResponseCallback
      ): Promise<any>;
      ...
      function remove_all_tags(
        public_ids: string[],
        options?: { tag?: string; resource_type?: ResourceType; type?: DeliveryType },
        callback?: ResponseCallback
      ): Promise<any>;
